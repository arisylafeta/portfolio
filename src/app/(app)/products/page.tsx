  ...
  return (
    <div className="py-12 md:py-16">
      <div className="mx-auto md:max-w-3xl">
        <div className="screen-line-after border-x border-edge px-4 py-2.5">
        ...
        <div className="relative aspect-2/1 border-x border-edge bg-white text-black sm:aspect-3/1 dark:bg-black dark:text-white">
          <FlickeringGrid
